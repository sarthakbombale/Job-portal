      ...
      <footer className="footer">
        <div className="container d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
          <div className="footer-branding">
            ...
            <span className="footer-tagline">Smart hiring, simplified.</span>
          </div>
          <div className="social-links" aria-label="Social links">
            <a href="https://github.com/sarthakbombale" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="GitHub">
              <GitHubIcon />
            </a>
            <a href="https://www.linkedin.com/in/sarthak-bombale-387705387" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="LinkedIn">
              <LinkedInIcon />
            </a>
            <a href="mailto:support@jobgenie.com" className="social-link" aria-label="Email">
              <Mail size={18} />
            </a>
          </div>
        </div>
